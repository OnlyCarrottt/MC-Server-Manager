...
A simple Windows application to manage multiple Minecraft servers from one place.
...
Configure Java path, RAM (Xms / Xmx), and arguments
...
Java 21 or newer (Java 25 works)

Minecraft server jar (Paper, Spigot, etc.)
...
Place each server in its own folder
...
Configure the Java path, RAM (Xms / Xmx), and enable Auto EULA if needed
